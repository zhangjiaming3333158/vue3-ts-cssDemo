...
const Close = () => {
  container?.value?.classList.remove('show-nav')
}
const Open = () => {
  container?.value?.classList.add('show-nav')
}
</script>

<style scoped lang="scss">
@import url('https://fonts.googleapis.com/css?family=Lato&display=swap'); //引入字体
* {
